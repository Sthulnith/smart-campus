                        ...
                        <td className="px-4 py-4">
                          <div className="flex items-center gap-2">
                            <div className="relative min-w-[200px]">
                              <UserCog className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400" />
                              <select
                                ...
                                className="w-full pl-10 pr-2 py-2 rounded-xl border border-slate-200 text-xs text-slate-700 bg-white disabled:bg-slate-100 disabled:text-slate-400"
                              >
