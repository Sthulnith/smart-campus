    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/notifications").hasAnyRole("ADMIN", "USER", "STUDENT", "STAFF", "TECHNICIAN")
                        .requestMatchers(HttpMethod.GET, "/api/notifications/preferences").hasAnyRole("ADMIN", "USER", "STUDENT", "STAFF", "TECHNICIAN")
                        .requestMatchers(HttpMethod.PUT, "/api/notifications/preferences").hasAnyRole("ADMIN", "USER", "STUDENT", "STAFF", "TECHNICIAN")
